...
// a compare to c id uncommon add to U
        for(int i=0;i<5;i++)
            {
                for(int j=0;j<idx;j++)
                {
        ...
        // B compare to c id uncommon add to U
        for(int i=0;i<5;i++)
                    {
                        for(int j=0;j<idx;j++)
                        {
